...
class BaseTestCase(unittest.TestCase):
    return_peak = ['#', '# U.S. Geological Survey', '# National Water Information System',
                   '# Retrieved: 2017-07-03 15:51:52 EDT', '#',
                   '# ---------------------------------- WARNING ----------------------------------------',
                   '# Some of the data that you have obtained from this U.S. Geological Survey database',
                   "# may not have received Director's approval. Any such data values are qualified",
                   '# as provisional and are subject to revision. Provisional data are released on the',
                   '# condition that neither the USGS nor the United States Government may be held liable',
                   '# for any damages resulting from its use.', '#', '# More data may be available offline.',
                   '# For more information on these data,  contact  USGS Water Data Inquiries.',
                   '# This file contains the annual peak streamflow data.', '#',
                   '# This information includes the following fields:', '#', '#  agency_cd     Agency Code',
                   ...
                   '#  ag_gage_ht_cd maximum Gage height code', '#', '# Sites in this file include:',
                   '#  USGS 05481950 Beaver Creek near Grimes, IA', '#',
                   '# Peak Streamflow-Qualification Codes(peak_cd):', '#   1 ... Discharge is a Maximum Daily Average',
                   '#   2 ... Discharge is an Estimate', '#   3 ... Discharge affected by Dam Failure',
                   ...
                   '#   6 ... Discharge affected by Regulation or Diversion', '#   7 ... Discharge is an Historic Peak',
                   ...
                   '#   1 ... Gage height affected by backwater', '#   2 ... Gage height not the maximum for the year',
                   '#   3 ... Gage height at different site and(or) datum',
                   '#   4 ... Gage height below minimum recordable elevation', '#   5 ... Gage height is an estimate',
    ...
    return_dv = ['# ---------------------------------- WARNING ----------------------------------------',
                 ...
                 '# retrieved: 2017-07-03 15:51:52 -04:00\t(natwebvaas01)', '#',
                 ...
                 'agency_cd\tsite_no\tdatetime\t43051_00060_00003\t43051_00060_00003_cd', '5s\t15s\t20d\t14n\t10s',
...
class TestReqPeakData(BaseTestCase):
    ...
    def test_bad_status_code(self):
        with requests_mock.Mocker() as m:
            ...
            self.assertEqual(req_peak_data(self.site, self.P_END_DT, self.prefix), None)

    def test_valid_data(self):
        with requests_mock.Mocker() as m:
            m.get(self.mock_url, text=self.mock_response_peak)
            self.assertEqual(req_peak_data(self.site, self.P_END_DT, self.prefix), [self.mock_response_peak])

    def test_bad_site(self):
        self.assertEqual(req_peak_data('x', self.P_END_DT, self.prefix), None)
        self.assertEqual(req_peak_data('', self.P_END_DT, self.prefix), None)

    def test_bad_url(self):
        self.assertEqual(req_peak_data(self.site, self.P_END_DT, 'badurl.noob'), None)
        self.assertEqual(req_peak_data(self.site, self.P_END_DT, ''), None)
...
class TestParsePeakData(BaseTestCase):
    def setUp(self):
        ...
        self.valid_parsed = [{'label': '1960', 'value': 5480}, {'label': '1961', 'value': 1870},
                             {'label': '1962', 'value': 3780}, {'label': '1963', 'value': 2540},
                             {'label': '1964', 'value': 2010}, {'label': '1965', 'value': 4230},
                             {'label': '1966', 'value': 5470}, {'label': '1967', 'value': 4000},
                             {'label': '1968', 'value': 2000},
                             {'label': '1969', 'value': 4050}, {'label': '1970', 'value': 3810},
                             {'label': '1971', 'value': 1900}, {'label': '1972', 'value': 1080},
                             {'label': '1973', 'value': 4130},
                             {'label': '1974', 'value': 7340}, {'label': '1975', 'value': 2500},
                             {'label': '1976', 'value': 1960}, {'label': '1977', 'value': 852},
                             {'label': '1978', 'value': 2980},
                             {'label': '1979', 'value': 4700}, {'label': '1980', 'value': 1730},
                             {'label': '1981', 'value': 1140}, {'label': '1982', 'value': 2780},
                             {'label': '1983', 'value': 3130},
                             {'label': '1984', 'value': 3220}, {'label': '1986', 'value': 7980},
                             {'label': '1987', 'value': 2610}, {'label': '1989', 'value': 1540},
                             {'label': '1990', 'value': 5580},
                             {'label': '1991', 'value': 3340}, {'label': '1992', 'value': 1790},
                             {'label': '1993', 'value': 14300}, {'label': '1994', 'value': 1580},
                             {'label': '1995', 'value': 1960},
                             {'label': '1996', 'value': 1410}, {'label': '1997', 'value': 1920},
                             {'label': '1998', 'value': 4280}, {'label': '1999', 'value': 3820},
                             {'label': '2000', 'value': 533},
                             {'label': '2001', 'value': 2350}, {'label': '2002', 'value': 912},
                             {'label': '2003', 'value': 3160}, {'label': '2004', 'value': 7300},
                             {'label': '2005', 'value': 2530},
                             {'label': '2006', 'value': 1740}, {'label': '2007', 'value': 6850},
